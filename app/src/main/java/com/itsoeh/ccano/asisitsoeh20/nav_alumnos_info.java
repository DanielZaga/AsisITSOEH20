...
public class nav_alumnos_info extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.nav_alumnos);
    ...
    private void onClickRegresar() {
        Intent enviarAMenu = new Intent(nav_alumnos_info.this, nav_alumnos.class);
